...
<h1 class="app-page-title">equipement</h1>
			    <hr class="mb-4">
	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="post" action="{{route('equipements.store')}}">
								...
								<div class="mb-3">
									<label for="setting-input-numero_serie" class="form-label">Numéro de série <span class="text-danger">*</span></label>
								...
								<div class="mb-3">
									<label for="setting-input-marque" class="form-label">Marque <span class="text-danger">*</span></label>
								...
								<div class="mb-3">
									<label for="setting-input-modele" class="form-label">Modèle <span class="text-danger">*</span></label>
